                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('chart-chartist') }}">Chartist Charts</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Chartist Chart</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo1" class="ct-chart ct-chart-line"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo2" class="ct-chart ct-chart-area"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo3" class="ct-chart ct-chart-bar"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo4" class="ct-chart ct-chart-stacked"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo5" class="ct-chart ct-chart-horizontalbar"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo6" class="ct-chart ct-chart-pie"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo7" class="ct-chart ct-chart-donut"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartist-wrapper">
                                            <div id="chartistdemo8" class="ct-chart ct-chart-gauge"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
