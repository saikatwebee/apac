            ...
            <div class="app-container">
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-toastr') }}">Toastr</a> </li>
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Toastr</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- end row -->
                        <!-- start Toastr contant -->
                        <div class="row">
                            <div class="col-12 toastr-wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-lg-4 mb-4">
                                                        <div class="control-group">
                                                            <div class="controls">
                                                                ...
                                                                <label class="control-label mt-3" for="message">Message</label>
                                                        ...
                                                        <div class="control-group mt-4 mb-4">
                                                            <div class="controls">
                                                                <div class="form-group form-check mb-0 py-2">
                                                                    <input type="checkbox" class="form-check-input" value="checked" id="closeButton">
                                                                    <label class="form-check-label" for="closeButton">Close Button</label>
                                                                </div>
                                                            </div>
                                                            <div class="controls">
                                                                <div class="form-group form-check mb-0 py-2">
                                                                    <input type="checkbox" class="form-check-input" value="checked" id="addBehaviorOnToastClick">
                                                                    <label class="form-check-label" for="addBehaviorOnToastClick">Add behavior on toast click</label>
                                                                </div>
                                                            </div>
                                                            <div class="controls">
                                                                <div class="form-group form-check mb-0 py-2">
                                                                    <input type="checkbox" class="form-check-input" value="checked" id="debugInfo">
                                                                    <label class="form-check-label" for="debugInfo">Debug</label>
                                                                </div>
                                                            </div>
                                                            <div class="controls">
                                                                <div class="form-group form-check mb-0 py-2">
                                                                    <input type="checkbox" class="form-check-input" value="checked" id="progressBar">
                                                                    <label class="form-check-label" for="progressBar">Progress Bar</label>
                                                                </div>
                                                            </div>
                                                            <div class="controls">
                                                                <div class="form-group form-check mb-0 py-2">
                                                                    <input type="checkbox" class="form-check-input" value="checked" id="preventDuplicates">
                                                                    <label class="form-check-label" for="preventDuplicates">Prevent Duplicates</label>
                                                                </div>
                                                            </div>
                                                            <div class="controls">
                                                                <div class="form-group form-check mb-0 py-2">
                                                                    <input type="checkbox" class="form-check-input" value="checked" id="addClear">
                                                                    <label class="form-check-label" for="addClear">Add button to force clearing a toast, ignoring focus</label>
                                                                </div>
                                                            </div>
                                                            <div class="controls">
                                                                <div class="form-group form-check mb-0 py-2">
                                                                    <input type="checkbox" class="form-check-input" value="checked" id="newestOnTop">
                                                    ...
                                                    <div class="col-lg-2 mb-4">
                                                        <div class="control-group" id="toastTypeGroup">
                                                            <div class="controls">
                                                                ...
                                                                <label class="d-block mb-2">Toast Type</label>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="toasts" id="success" value="success" checked>
                                                                    <label class="form-check-label" for="success">Success</label>
                                                                </div>

                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="toasts" id="info" value="info">
                                                                    <label class="form-check-label" for="info">Info</label>
                                                                </div>

                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="toasts" id="warning" value="warning">
                                                                    <label class="form-check-label" for="warning">Warning</label>
                                                                </div>

                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="toasts" id="error" value="error">
                                                                    <label class="form-check-label" for="error">Error</label>
                                                                </div>

                                                            </div>
                                                        </div>
                                                        <div class="control-group mt-4" id="positionGroup">
                                                            <div class="controls">
                                                                <label>Position</label>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-top-right" value="toast-top-right" checked>
                                                                    <label class="form-check-label" for="toast-top-right">Top Right</label>
                                                                </div>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-bottom-right" value="toast-bottom-right">
                                                                    <label class="form-check-label" for="toast-bottom-right">Bottom Right</label>
                                                                </div>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-bottom-left" value="toast-bottom-left">
                                                                    <label class="form-check-label" for="toast-bottom-left">Bottom Left</label>
                                                                </div>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-top-left" value="toast-top-left">
                                                                    <label class="form-check-label" for="toast-top-left">Top Left</label>
                                                                </div>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-top-full-width" value="toast-top-full-width">
                                                                    <label class="form-check-label" for="toast-top-full-width">Top Full Width</label>
                                                                </div>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-bottom-full-width" value="toast-bottom-full-width">
                                                                    <label class="form-check-label" for="toast-bottom-full-width">Bottom Full Width</label>
                                                                </div>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-top-center" value="toast-top-center">
                                                                    <label class="form-check-label" for="toast-top-center">Top Center</label>
                                                                </div>
                                                                <div class="form-check mb-0 py-2">
                                                                    <input class="form-check-input" type="radio" name="positions" id="toast-bottom-center" value="toast-bottom-center">
                                                                    <label class="form-check-label" for="toast-bottom-center">Bottom Center</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 mb-4">
                                                        <div class="control-group">
                                                            <div class="controls">
                                                                ...
                                                                <label class="control-label mt-3" for="hideEasing">Hide Easing</label>
                                                                <input id="hideEasing" type="text" placeholder="swing, linear" class="form-control" value="linear" />
                                                                <label class="control-label mt-3" for="showMethod">Show Method</label>
                                                                <input id="showMethod" type="text" placeholder="show, fadeIn, slideDown" class="form-control" value="fadeIn" />
                                                                <label class="control-label mt-3" for="hideMethod">Hide Method</label>
                                                    ...
                                                    <div class="col-lg-4 mb-4">
                                                        <div class="control-group">
                                                            <div class="controls">
                                                                ...
                                                                <label class="control-label mt-3" for="hideDuration">Hide Duration</label>
                                                                <input id="hideDuration" type="number" placeholder="ms" class="form-control" value="1000" />
                                                                <label class="control-label mt-3" for="timeOut">Time out</label>
                                                                <input id="timeOut" type="number" placeholder="ms" class="form-control" value="5000" />
                                                                <label class="control-label mt-3" for="extendedTimeOut">Extended time out</label>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <button type="button" class="btn btn-primary mr-1 mb-1" id="showtoast">Show Toast</button>
                                                        <button type="button" class="btn btn-warning mr-1 mb-1" id="cleartoasts">Clear Toasts</button>
                                                        <button type="button" class="btn btn-danger mr-1 mb-1" id="clearlasttoast">Clear Last Toast</button>
                                                    </div>
                                                </div>
                                                <div class="row mt-4">
                                                    <div class="col">
                                                        <pre id='toastrOptions' class="mb-0"> Output: </pre>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
