                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('chart-knob') }}">Knob Chart</a> </li>
                                </ul>
                            </li>
                            <li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Knob Chart</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="jqueryknob-wrapper text-center">
                                            <input class="knob" data-width="200" data-displayInput=false value="35" data-fgColor="#8854d0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="jqueryknob-wrapper text-center">
                                            <input class="knob" data-width="200" data-cursor=true data-fgColor="#fbaf54" data-thickness=.3 value="29">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="jqueryknob-wrapper text-center">
                                            <input class="knob" data-width="200" data-min="-100" data-fgColor="#eb3b5a" data-displayPrevious=true value="44">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="jqueryknob-wrapper text-center">
                                            <input class="knob" data-angleOffset=90 data-linecap=round data-fgColor="#fbaf54" value="35">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="jqueryknob-wrapper text-center">
                                            <input class="knob" data-angleOffset=-125 data-angleArc=250 data-fgColor="#32b432" data-rotation="anticlockwise" value="35">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="jqueryknob-wrapper text-center">
                                            <input class="knob" data-thickness=".4" data-fgColor="#4776E6" readonly value="22">
                                        </div>
                                    </div>
                                </div>
                            </div>
