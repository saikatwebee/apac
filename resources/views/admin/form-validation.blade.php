                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('form-validation') }}">Validation</a> </li>
                                </ul>
                            </li>
                        ...
                        <div class="row formavlidation-wrapper">
                            ...
                            <div class="col-xl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Validation Icons</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Using feedback icons</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form id="signupForm3" method="post" class="form-horizontal">
                                            <div class="form-group">
