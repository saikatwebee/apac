                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a class="has-arrow" href="javascript: void(0);">Buttons</a>
                                        <ul aria-expanded="false">
                                            ...
                                            <li class="active"> <a href="{{ url('ui-button-groups') }}">Group Buttons</a> </li>
                                        </ul>
                                    </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Group Buttons</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Sizing Button</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">toolbar Button</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with Group Buttons">
                                            <div class="btn-group mr-2 mb-2 mb-xxs-0" role="group" aria-label="First group">
                                                <button type="button" class="btn btn-primary">1</button>
                                                <button type="button" class="btn btn-primary">2</button>
                                                <button type="button" class="btn btn-primary">3</button>
                                                <button type="button" class="btn btn-primary">4</button>
                                            </div>
                                            <div class="btn-group mr-2 mb-2 mb-xxs-0" role="group" aria-label="Second group">
                                                <button type="button" class="btn btn-primary">5</button>
                                                <button type="button" class="btn btn-primary">6</button>
                                                <button type="button" class="btn btn-primary">7</button>
                                            </div>
                                            <div class="btn-group mb-2 mb-xxs-0" role="group" aria-label="Third group">
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Nesting Button</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="btn-group">
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Vertical Button</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="btn-group-vertical">
                                            <button type="button" class="btn btn-lg btn-primary m-0">Button</button>
                                            <button type="button" class="btn btn-lg btn-primary m-0">Button</button>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary dropdown-toggle m-0" data-toggle="dropdown">Dropdown</button>
                                                <div class="dropdown-menu custom-dropdown p-4">
                                                    <a class="dropdown-item" href="javascript:void(0)">Dropdown link1</a>
                                                    <a class="dropdown-item" href="javascript:void(0)">Dropdown link2</a>
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-primary m-0">Button</button>
                                            <button type="button" class="btn btn-primary m-0">Button</button>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary dropdown-toggle m-0" data-toggle="dropdown">Dropdown</button>
                                                <div class="dropdown-menu custom-dropdown p-4">
