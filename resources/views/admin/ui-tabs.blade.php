                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-tabs') }}">Tabs</a> </li>
                        ...
                        <div class="row tabs-contant">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Tab Default </h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab">
                            ...
                            <div class="col-xxl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Tab Nav Border Bottom</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="row tabs-contant">
                            <div class="col-xxl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Tab Nav Border top</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab nav-bt">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active show" id="home-03-tab" data-toggle="tab" href="#home-03" role="tab" aria-controls="home-03" aria-selected="true">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-03-tab" data-toggle="tab" href="#profile-03" role="tab" aria-controls="profile-03" aria-selected="false">Profile </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="portfolio-03-tab" data-toggle="tab" href="#portfolio-03" role="tab" aria-controls="portfolio-03" aria-selected="false">Portfolio </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="contact-03-tab" data-toggle="tab" href="#contact-03" role="tab" aria-controls="contact-03" aria-selected="false">Contact </a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane fade py-3 active show" id="home-03" role="tabpanel" aria-labelledby="home-03-tab">
                                                    <p>The sad thing is the majority of people have no clue about what they truly want. They have no clarity. When asked the question, responses will be superficial at best, and at worst, will be what someone else wants for them.Do it today. Remind yourself of someone you know who died suddenly and the fact that there is no guarantee that tomorrow will come.</p>
                                                </div>
                                                <div class="tab-pane fade py-3" id="profile-03" role="tabpanel" aria-labelledby="profile-03-tab">
                                                ...
                                                <div class="tab-pane fade py-3" id="portfolio-03" role="tabpanel" aria-labelledby="portfolio-03-tab">
                                                    <p>Begin with the outcome in mind. You must improve upon, clarify and make clear just exactly who and what you are going to be doing, experiencing, living and having in 10 years. This is the first step of the process! Key: Notice how you felt excited and optimistic when you did this? The reason is simple. It’s the life you are designing instead of the one that was given you and that you have lived with less intention and purpose to date.</p>
                                                </div>
                                                <div class="tab-pane fade py-3" id="contact-03" role="tabpanel" aria-labelledby="contact-03-tab">
                                                    <p>We also know those epic stories, those modern-day legends surrounding the early failures of such supremely successful folks as Michael Jordan and Bill Gates. We can look a bit further back in time to Albert Einstein or even further back to Abraham Lincoln. Success is something of which we all want more.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xxl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Tab Nav Icon</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab tab-border">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active show" id="home-10-tab" data-toggle="tab" href="#home-10" role="tab" aria-controls="home-10" aria-selected="true"> <i class="fa fa-home"></i> Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-10-tab" data-toggle="tab" href="#profile-10" role="tab" aria-controls="profile-10" aria-selected="false"><i class="fa fa-user"></i> Profile </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="portfolio-10-tab" data-toggle="tab" href="#portfolio-10" role="tab" aria-controls="portfolio-10" aria-selected="false"><i class="fa fa-picture-o"></i> Portfolio </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="contact-10-tab" data-toggle="tab" href="#contact-10" role="tab" aria-controls="contact-10" aria-selected="false"><i class="fa fa-check-square-o"></i> Contact </a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane fade active show" id="home-10" role="tabpanel" aria-labelledby="home-10-tab">
                                                    <p>We also know those epic stories, those modern-day legends surrounding the early failures of such supremely successful folks as Michael Jordan and Bill Gates. We can look a bit further back in time to Albert Einstein or even further back to Abraham Lincoln.Use a past defeat as a motivator. Remind yourself you have nowhere to go except up as you have already been at the bottom.</p>
                                                </div>
                        ...
                        <div class="row tabs-contant">
                            ...
                            <div class="col-xxl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Tab Nav Icon Center</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab tab-border nav-center">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active show" id="home-05-tab" data-toggle="tab" href="#home-05" role="tab" aria-controls="home-05" aria-selected="true"> <i class="fa fa-home"></i> Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-05-tab" data-toggle="tab" href="#profile-05" role="tab" aria-controls="profile-05" aria-selected="false"><i class="fa fa-user"></i> Profile </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="portfolio-05-tab" data-toggle="tab" href="#portfolio-05" role="tab" aria-controls="portfolio-05" aria-selected="false"><i class="fa fa-picture-o"></i> Portfolio </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="contact-05-tab" data-toggle="tab" href="#contact-05" role="tab" aria-controls="contact-05" aria-selected="false"><i class="fa fa-check-square-o"></i> Contact </a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                            ...
                            <div class="col-xxl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title"> Tab Nav Icon Right</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab tab-border nav-right">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active show" id="home-06-tab" data-toggle="tab" href="#home-06" role="tab" aria-controls="home-06" aria-selected="true"> <i class="fa fa-home"></i> Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-06-tab" data-toggle="tab" href="#profile-06" role="tab" aria-controls="profile-06" aria-selected="false"><i class="fa fa-user"></i> Profile </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="portfolio-06-tab" data-toggle="tab" href="#portfolio-06" role="tab" aria-controls="portfolio-06" aria-selected="false"><i class="fa fa-picture-o"></i> Portfolio </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="contact-06-tab" data-toggle="tab" href="#contact-06" role="tab" aria-controls="contact-06" aria-selected="false"><i class="fa fa-check-square-o"></i> Contact </a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                        ...
                        <div class="row tabs-contant">
                            <div class="col-xxl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title"> Tab Nav Round</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab round">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active show" id="home-07-tab" data-toggle="tab" href="#home-07" role="tab" aria-controls="home-07" aria-selected="true"> <i class="fa fa-home"></i> Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-07-tab" data-toggle="tab" href="#profile-07" role="tab" aria-controls="profile-07" aria-selected="false"><i class="fa fa-user"></i> Profile </a>
                                                </li>
                                                <li class="nav-item">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade py-3" id="contact-07" role="tabpanel" aria-labelledby="contact-07-tab">
                                                    <p>Imagine reaching deep inside you for all the strength and wisdom that you need to make this decision today. As you do so, imagine that when you choose to make that decision that deep inside your mind you are switching off the alternative path, you are switching off the opportunity to drift back to that place. Then step out and take your future path. Absorb yourself in the sensations, the feelings, the sights, the sounds and of course continue to engage in your future the way I have discussed in previous articles on this blog.</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="tab tab-vertical">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active show" id="home-09-tab" data-toggle="tab" href="#home-09" role="tab" aria-controls="home-09" aria-selected="true"> Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-09-tab" data-toggle="tab" href="#profile-09" role="tab" aria-controls="profile-09" aria-selected="false"> Profile </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="portfolio-09-tab" data-toggle="tab" href="#portfolio-09" role="tab" aria-controls="portfolio-09" aria-selected="false">Portfolio </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="contact-09-tab" data-toggle="tab" href="#contact-09" role="tab" aria-controls="contact-09" aria-selected="false"> Contact </a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
