            ...
            <div class="app-container">
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-list-group') }}">List Group</a> </li>
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">List Groups</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- end row -->
                        <!-- start List group contant -->
                        <div class="row list-group-contant">
                            <div class="col-lg-6">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group">
                                                    <li class="list-group-item">Quick Response Time</li>
                                                    <li class="list-group-item">Developing the Vision</li>
                                                    <li class="list-group-item">Making the decision</li>
                                                    <li class="list-group-item">Focus – having a plan</li>
                                                    <li class="list-group-item">Taking action</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 list-group-1">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group">
                                                    <li class="list-group-item">Award-winning design</li>
                                                    <li class="list-group-item list-group-item-primary">Super Fast Customer support</li>
                                                    <li class="list-group-item list-group-item-secondary">Easy to Customize pages</li>
                                                    <li class="list-group-item list-group-item-success">Email Design</li>
                                                    <li class="list-group-item list-group-item-danger">Powerful Performance</li>
                                                    <li class="list-group-item list-group-item-warning">Many Style Available</li>
                                                    <li class="list-group-item list-group-item-info">Unlimited layouts</li>
                                                    <li class="list-group-item list-group-item-light"> Parallax Sections</li>
                                                    <li class="list-group-item list-group-item-dark"> The Benefits</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <div class="list-group">
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action active">Quick Response Time</a>
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action">Easy to Customize pages</a>
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action">Supercharge your motivation</a>
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action">Experienced Professionals</a>
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action disabled">Quick Response time</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Links and Buttons Disabled</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="list-group">
                                                    ...
                                                    <button type="button" class="list-group-item list-group-item-action disabled">Commit your decision to paper</button>
                                                    <button type="button" class="list-group-item list-group-item-action disabled">Action – putting your plans into play</button>
                                                    <button type="button" class="list-group-item list-group-item-action disabled">Commit your decision to paper,</button>
                                                    <button type="button" class="list-group-item list-group-item-action disabled" disabled>Nothing changes until something moves</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group">
                                                    <li class="list-group-item active">Use a past defeat as a motivator.</li>
                                                    <li class="list-group-item">The Truth About Success</li>
                                                    <li class="list-group-item">Making the decision</li>
                                                    <li class="list-group-item">Easy to Customize pages</li>
                                                    <li class="list-group-item">Parallax Sections</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group">
                                                    <li class="list-group-item disabled">Perfect design</li>
                                                    <li class="list-group-item disabled">Client Management</li>
                                                    <li class="list-group-item disabled">Portfolio</li>
                                                    <li class="list-group-item disabled">Corporate Culture</li>
                                                    <li class="list-group-item disabled">Company Philosophy</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="list-group">
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action flex-column align-items-start active">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h5 class="mb-1 text-white">Experienced Professionals</h5>
                                                            <small class="text-white d-none d-sm-block">3 days ago</small>
                                                        </div>
                                                        <p class="text-white d-sm-none"><small>3 days ago</small></p>
                                                        <p class="mb-1 text-white">Text of the printin a galley of type and bled it to a type specimen book.</p>
                                                        <small class="text-white">Success isn’t really that difficult.</small>

                                                    </a>
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action flex-column align-items-start">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h5 class="mb-1">Making the decision</h5>
                                                            <small class="text-muted d-none d-sm-block">3 days ago</small>
                                                        </div>
                                                        <p class="text-muted d-sm-none"><small>3 days ago</small></p>
                                                        <p class="mb-1">If success is a process with a number of defined steps, then it is just like any other process.</p>
                                                        <small class="text-muted">Success isn’t really that difficult.</small>
                                                    </a>
                                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action flex-column align-items-start">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h5 class="mb-1">Taking action</h5>
                                                            <small class="text-muted d-none d-sm-block">3 days ago</small>
                                                        </div>
                                                        <p class="text-muted d-sm-none"><small>3 days ago</small></p>
                                                        <p class="mb-1">Trying to go through life without clarity is similar to sailing a rudder-less ship.</p>
                                                        <small class="text-muted">Success isn’t really that difficult.</small>
                                                    </a>
                                                </div>
                                            </div>
