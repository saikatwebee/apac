                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li><a href="{{ url('app-chat') }}" aria-expanded="false"><i
                                        class="nav-icon ti ti-comment"></i><span class="nav-title">Chat</span></a> </li>
                            ...
                            <li><a href="{{ url('mail-inbox') }}" aria-expanded="false"><i
                            ...
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"> <i
                                        ...
                                        class="nav-title">Widgets</span> <span
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    <li class="active"> <a href="{{ url('chart-apex') }}">Apex Chart</a> </li>
