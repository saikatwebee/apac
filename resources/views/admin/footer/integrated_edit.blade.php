                ...
                <div class="breadcrumb-bar align-items-center">
                    <nav>
                        <ol class="breadcrumb p-0 m-b-0">
                            ...
                            <li class="breadcrumb-item active text-primary" aria-current="page">Director - Edit</li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-statistics">
                <form class="validate-form" method="POST" action="{{route('footer/integrated.update',$integratedinfo->id)}}" enctype="multipart/form-data" id="footer_form" onsubmit="return validateForm();" name="footer_form">
                    @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group @error('integrated_year') has-error @enderror">
                                    <label for="integrated_year" class="control-label">{{ __('Integrated Year') }}<span class="text-danger">*</span></label>
                                        ...
                                        <input type="text" class="form-control" name="integrated_year" id="integrated_year"  value="{{$integratedinfo->integrated_year}}">
                                ...
                                <div class="form-group @error('integrated_pdf_name') has-error @enderror">
                                    <label for="integrated_pdf_name" class="control-label">{{ __('Integrated PDF Name') }}<span class="text-danger">*</span></label>
                                        ...
                                        <input type="text" class="form-control" name="integrated_pdf_name" id="integrated_pdf_name" value="{{$integratedinfo->integrated_pdf_name}}">
                                ...
                                <label class="control-label text-bold" for="integrated_pdf_file">{{ __('Integrated PDF File') }}<span class="text-danger">*</span></label>
                                    ...
                                    <input id="integrated_pdf_file" name="integrated_pdf_file" class="form-control" type="file"  value="{{$integratedinfo->integrated_pdf_file}}"/>
                                    <div class="error" id="integrated_pdf_fileErr"></div>
                                        ...
                                        @endif
                                        <a href=" https://cogereonline.com/apac/public/uploads/integrated/{{$integratedinfo->integrated_pdf_file}}" target="_blank" >
...
<script>
  ...
  function validateForm() {
      ...
      var  integrated_yearErr=integrated_pdf_nameErr=true;
      ...
      if((integrated_yearErr||integrated_pdf_nameErr) == true) {
        return false;
      }
  }
  </script>
