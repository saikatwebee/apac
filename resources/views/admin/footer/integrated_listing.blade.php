        ...
        <div class="col-md-12 m-b-30">
            <div class="d-block d-lg-flex flex-nowrap align-items-center">
                ...
                <div class="ml-auto d-flex align-items-center secondary-menu text-center">
                    <a href="{{ route('footer/integrated.create') }}" class="tooltip-wrapper" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add News">
                        ...
                        <table class="display table table-striped table-hover" id="example">
                            ...
                            <tbody>
                                <?php
                                        $id=1;
                                        ?>
                                @foreach ($integratedinfo as $row)
                                <tr>


                                     <td>{{$id}}</td>
                                    <td>{{$row->integrated_year}}</td>
                                    <td>{{$row->integrated_pdf_name}}</td>
                                    <td>{{$row->integrated_pdf_file}}</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('footer/integrated.edit' ,$row->id) }}">
                                            ...
                                            <form class="delete-form" method="POST" action="{{ route('footer/integrated.delete' ,$row->id) }}">
                                                @csrf
                                                @method('DELETE')
