    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-statistics">
                ...
                <form class="validate-form" method="POST" action="{{route('footer/newsletter.update',$newsletterinfo->id)}}" enctype="multipart/form-data" id="footer_form" onsubmit="return validateForm();" name="footer_form">
                    @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <label class="control-label text-bold" for="newsletter_pdf_file">{{ __('Newsletter PDF File') }}<span class="text-danger">*</span></label>
                                    ...
                                    <input id="newsletter_pdf_file" name="newsletter_pdf_file" class="form-control" type="file"  value="{{$newsletterinfo->newsletter_pdf_file}}"/>
                                        ...
                                        @endif
                                        <a href=" {{ asset('uploads/newsletter/'.$newsletterinfo->newsletter_pdf_file)}}" target="_blank" >
...
<script>
  ...
  function validateForm() {
      ...
      var  newsletter_pdf_nameErr=true;
      ...
      if((newsletter_pdf_nameErr) == true) {
        return false;
      }
  }
  </script>
