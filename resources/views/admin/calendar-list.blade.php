                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active"><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">Calendar</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href='{{ url('calendar-full') }}'>Full Calendar</a> </li>
                                    <li class="active"> <a href='{{ url('calendar-list') }}'>Calendar List</a> </li>
                                </ul>
                            </li>
