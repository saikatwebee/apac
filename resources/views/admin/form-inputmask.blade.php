                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('form-inputmask') }}">Input Masks</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Input Mask</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ISBN1</label>
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="999-99-999-9999-9" class="form-control inputmask">
                                                    <span class="font-14 text-muted">e.g "999-99-999-9999-9"</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ISBN2</label>
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="999 99 999 9999 9" class="form-control inputmask">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ISBN3</label>
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="999/99/999/9999/9" class="form-control inputmask">
                                                    <span class="font-14 text-muted">999/99/999/9999/9</span>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="999.999.999.9999" class="form-control inputmask">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="9999:9999:9999:9:999:9999:9999:9999" class="form-control inputmask">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="99-9999999" class="form-control inputmask">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="(999) 999-9999" class="form-control inputmask">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="$ 999,999,999.99" class="form-control inputmask">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="" data-mask="99/99/9999" class="form-control inputmask">
