                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('chart-flot') }}">Flot Chart</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Flot Chart</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="flot-chart-wrapper">
                                            <div class="flot-container">
                                                <div id="flot-stacked" class="flot-wrapper"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Multiple Axis</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="flot-chart-wrapper">
                                            <div class="flot-container">
                                                <div id="flot-axes" class="flot-wrapper"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="flot-chart-wrapper">
                                            <div class="flot-container">
                                                <div id="flot-real-time" class="flot-wrapper"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Toggling Axis</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="flot-chart-wrapper">
                                            <div class="flot-container">
                                                <div id="flot-series-toggle" class="flot-wrapper"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
