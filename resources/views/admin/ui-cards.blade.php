                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-cards') }}">Cards</a> </li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card card-statistics ">
                                    <img class="card-img-top" src="assets/img/widget/01.jpg" alt="Card image cap">
                                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <h4 class="card-title">Featured Header</h4>
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title">Focus</h4>
                                        <p class="card-text">Focus is having the unwavering attention to complete what you set out to do. There are a million distractions in every facet of our lives. Telephones and e-mail, clients and managers, spouses and kids, TV, newspapers and radio – the distractions are everywhere and endless.</p>
                                        <a href="javascript:void(0)" class="btn btn-primary mt-2">Read More</a>
                                    </div>
                                </div>
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <h4 class="card-title">Featured Header and footer</h4>
                                    </div>
                                    <div class="card-body">
                                        <h5 class="card-title">The Truth About Success</h5>
                                        <p class="card-text">The first thing to remember about success is that it is a process – nothing more, nothing less. There is really no magic to it and it’s not reserved only for a select few people. As such, success really has nothing to do with luck, coincidence or fate.</p>
                                        <a href="javascript:void(0)" class="btn btn-primary mt-2">Read More</a>
                                    </div>
                            ...
                            <div class="col-12 mb-30">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <h4 class="card-title">Using grid markup</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <h4 class="card-title"> Making the decision </h4>
                                                        <p class="card-text"> Taking a decision to do something – this is the first step. We all know that nothing moves until someone makes a decision. The first action is always in making the decision to proceed. This is a fundamental step, which most people overlook.</p>
                                                        <a href="javascript:void(0)" class="btn btn-primary mt-2">Read More</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <h4 class="card-title">The old expression is absolutely true</h4>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics mb-30">
                                    ...
                                    <div class="card-body">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Quick Response Time</h4>
                                                <p class="card-text">Motivation cannot be an external force, it must come from within as the natural product of your desire to achieve something and your belief that you are capable to succeed at your goal.</p>
                                                <a href="javascript:void(0)" class="btn btn-primary mt-2">Go somewhere</a>
                                            </div>
                                        </div>
                                        <div class="card text-center">
                                            <div class="card-body">
                                                <h4 class="card-title">Experienced Professionals</h4>
                                                <p class="card-text">There are many people in the world with amazing talents who realize only a small percentage of their potential. We all know people who live this truth.</p>
                                                <a href="javascript:void(0)" class="btn btn-primary mt-2">Go somewhere</a>
                                            </div>
                                        </div>
                                        <div class="card text-right mb-0">
                                            <div class="card-body">
                                                <h4 class="card-title">Maximum Query Solved</h4>
                                                <p class="card-text">Text of the printin a galley of type and bled it to a type specimen book. It has survived not only five centuries make Lorem Ipsum is simply dummy.Success isn’t really that difficult.</p>
                                                <a href="javascript:void(0)" class="btn btn-primary mt-2">Go somewhere</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics mb-30">
                                    ...
                                    <div class="card-body">
                                        <div class="card-body">
                                            <h4 class="card-title">Commitment</h4>
                                            <p class="card-text">Commitment is something that comes from understanding that everything has its price and then having the willingness to pay that price. This is important because nobody wants to put significant effort into something, only to find out after the fact that the price was too high.</p>
                                            <a href="javascript:void(0)" class="btn btn-primary mt-2">Go somewhere</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics mb-30">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Nothing changes until something moves</h5>
                                        <p class="card-text">this is the battle cry of author and journalist Robert Ringer. And he is absolutely correct. Not all of the decision-making, clarity, planning, focus and belief in the world, will get you to where you want to be, without taking action! Action – putting your plans into play – that is what will get you to the destination. </p>
                                        <a href="javascript:void(0)" class="btn btn-primary mt-2">Go somewhere</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card card-statistics mb-30 card-contant">
                                    <div class="card-header">
                                        <h4 class="card-title">Background and color</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="card text-white bg-primary mb-3">
                                            <div class="card-header">
                                                <h4 class="card-title text-white">Primary</h4>
                                            </div>
                                            <div class="card-body">
                            ...
                            <div class="col-12 mb-30">
                                <div class="card card-statistics mb-30 card-contant1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card border-secondary text-center mb-3">
                                ...
                                <div class="card card-statistics card-group">
                                    <div class="card">
                                        <img class="card-img-top" src="assets/img/widget/08.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Clarity</h4>
                                            <p class="card-text">Having clarity of purpose and a clear picture of what you desire, is probably the single most important factor in achievement.</p>
                                        </div>
                                    ...
                                    <div class="card">
                                        <img class="card-img-top" src="assets/img/widget/09.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Focus</h4>
                                            <p class="card-text">Focus is having the unwavering attention to complete what you set out to do. There are a million distractions in every facet of our lives. </p>
                                        </div>
                                        <div class="card-footer">
                                            <small class="text-muted">Last updated 3 mins ago</small>
                                        </div>
                                    ...
                                    <div class="card">
                                        <img class="card-img-top" src="assets/img/widget/10.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Commitment </h4>
                                            <p class="card-text">The price is something not necessarily defined as financial. It could be time, effort, sacrifice, money or perhaps, something else. </p>
                                        </div>
                                        <div class="card-footer">
                                            <small class="text-muted">Last updated 3 mins ago</small>
                                        </div>
                                ...
                                <div class="card-deck m-b-30">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">Taking Action</h4>
                                ...
                                <div class="card card-statistics mb-0">
                                    <div class="card-header">
                                        <h4 class="card-title">Card Columns</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="card-columns">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Imagine reaching deep inside you for all the strength and wisdom that you need to make this decision today. </p>
                                                </div>
                                            </div>
                                            <div class="card p-3">
                                            ...
                                            <div class="card">
                                                <img class="card-img-top" src="assets/img/widget/07.jpg" alt="Card image cap">
                                                <div class="card-body">
                                                    <h4 class="card-title">The Truth About Success</h4>
                                                    <p class="card-text">Most people believe that success is difficult.</p>
                                                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                                                </div>
                                            </div>
                                            <div class="card bg-primary text-white text-center p-3">
                                                <blockquote class="blockquote mb-0">
                                                    <p class="text-white">Do it today. Remind yourself of someone you know who died suddenly and the fact that there is no guarantee that tomorrow will come.</p>
                                                    <footer class="blockquote-footer">
                                            ...
                                            <div class="card text-center">
                                                <div class="card-body">
                                                    <h4 class="card-title">Making the decision</h4>
                                                    <p class="card-text">Make a list of your achievements toward your long-term goal and remind yourself that intentions don’t count, only action’s.</p>
                                                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                                                </div>
                                            </div>
                                            <div class="card">
                                                <img class="card-img" src="assets/img/widget/08.jpg" alt="Card image">
                                            </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Let success motivate you. Find a picture of what epitomizes success to you and then pull it out when you are in need of motivation.</p>
                                                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                                                </div>
                                            </div>
                                        </div>
