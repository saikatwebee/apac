                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-nav') }}">Nav</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Nav</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 mb-30">
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Center Aligned</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Vertical Aligned</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-6 mb-30">
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Fill and justify</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills nav-fill">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="javascript:void(0)">Longer nav link</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="javascript:void(0)">Link</a>
                                            </li>
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Nav Longer Link</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Tabs with dropdowns</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Pills with dropdowns</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
