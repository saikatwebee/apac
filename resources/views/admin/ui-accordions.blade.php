                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-accordions') }}">Accordions</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Accordions</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Accordion Simple Fill</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="accordion" id="accordionsimplefill">
                                            <div class="mb-2 acd-group">
                                                ...
                                                <div id="collapse" class="collapse show" data-parent="#accordionsimplefill">
                                                    <div class="card-body">
                                                        <p>Motivation cannot be an external force, it must come from within as the natural product of your desire to achieve something and your belief that you are capable to succeed at your goal.</p>
                                            ...
                                            <div class="mb-2 acd-group">
                                                <div class="card-header rounded-0 bg-primary">
                                                    <h5 class="mb-0">
                                                        <a href="#collapse2" class="btn-block text-white text-left acd-heading collapsed" data-toggle="collapse">2. Experienced Professionals</a>
                                                    </h5>
                                                </div>
                                                <div id="collapse2" class="collapse" data-parent="#accordionsimplefill">
                                                    <div class="card-body">
                                                        <p>There are many people in the world with amazing talents who realize only a small percentage of their potential. We all know people who live this truth.</p>
                                            ...
                                            <div class="acd-group border-bottom-0">
                                                ...
                                                <div id="collapse3" class="collapse" data-parent="#accordionsimplefill">
                                                    <div class="card-body">
                                                        <p>Text of the printin a galley of type and bled it to a type specimen book. It has survived not only five centuries make Lorem Ipsum is simply dummy.Success isn’t really that difficult.</p>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Accordion Simple Border</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="accordion" id="accordionsimpleborder">
                                            <div class="mb-2 acd-group">
                                                <div class="card-header border rounded-0">
                                                    <h5 class="mb-0">
                                                        <a href="#collapse01" class="btn-block text-left text-muted acd-heading" data-toggle="collapse">1. Making the decision</a>
                                                    </h5>
                                                </div>
                                                <div id="collapse01" class="collapse show" data-parent="#accordionsimpleborder">
                                                    <div class="card-body">
                                                        <p>
                                                            We also know those epic stories, those modern-day legends surrounding the early failures of such supremely successful folks as Michael Jordan and Bill Gates. We can look a bit further back in time to Albert Einstein or even further back to Abraham Lincoln.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-2 acd-group">
                                                <div class="card-header rounded-0 border">
                                                    <h5 class="mb-0">
                                                        <a href="#collapse02" class="btn-block text-left text-muted acd-heading collapsed" data-toggle="collapse">2. Developing the Vision</a>
                                                    </h5>
                                                </div>
                                                <div id="collapse02" class="collapse" data-parent="#accordionsimpleborder">
                                                    <div class="card-body">
                                                        <p>
                                                            Positive pleasure-oriented goals are much more powerful motivators than negative fear-based ones. Although each is successful separately, the right combination of both is the most powerful motivational force known to humankind.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="acd-group border-bottom-0">
                                                <div class="card-header rounded-0 border">
                                                    <h5 class="mb-0">
                                                        <a href="#collapse03" class="btn-block  text-left text-muted acd-heading collapsed" data-toggle="collapse">3. Taking Action</a>
                                                    </h5>
                                                </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Accordion Fill Border Radius</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="accordion" id="accordionborderradius">
                                            <div class="mb-2 acd-group">
                                                <div class="card-header border-radius-10 border">
                                                    <h5 class="mb-0">
                                                        <a href="#collapse4-1" class="btn-block text-left text-muted acd-heading" data-toggle="collapse">1. Fast Customer support</a>
                                                    </h5>
                                                </div>
                                                <div id="collapse4-1" class="collapse show" data-parent="#accordionborderradius">
                                                    <div class="card-body">
                                                        <p>Focus is having the unwavering attention to complete what you set out to do. There are a million distractions in every facet of our lives. Telephones and e-mail, clients and managers, spouses and kids, TV, newspapers and radio – the distractions are everywhere and endless.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-2 acd-group">
                                                <div class="card-header border-radius-10 border">
                                                    <h5 class="mb-0">
                                                        <a href="#collapse4-2" class="btn-block text-left text-muted acd-heading collapsed" data-toggle="collapse">2. Build websites easily</a>
                                                    </h5>
                                                </div>
                                                <div id="collapse4-2" class="collapse" data-parent="#accordionborderradius">
                                                    <div class="card-body">
                                                        <p>Everyone wants a piece of us and the result can be totally overwhelming.you should consider developing an action orientation that will keep you motivated to move forward at all times.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="acd-group border-bottom-0">
                                                <div class="card-header border-radius-10 border">
                                                    <h5 class="mb-0">
                                                        <a href="#collapse4-3" class="btn-block  text-left text-muted acd-heading collapsed" data-toggle="collapse">3. Customizability</a>
                                                    </h5>
                                                </div>
