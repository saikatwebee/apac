                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-media') }}">Media</a> </li>
                        ...
                        <div class="row media-contant">
                            <div class="col-12 col-lg-6">
                                <div class="card card-statistics media-contant">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <img class="mr-3 mb-3 mb-xxs-0 img-fluid" src="assets/img/avtar/01.jpg" alt="image">
                                ...
                                <div class="card card-statistics media-contant">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            ...
                                            <img class="mr-3 mb-3 mb-xxs-0 img-fluid" src="assets/img/avtar/02.jpg" alt="image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row media-contant">
                            <div class="col-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <img class="mr-3 mb-3 mb-xxs-0 img-fluid" src="assets/img/avtar/03.jpg" alt="image">
                                            <div class="media-body">
                                                <h5 class="mt-0">AnnaHorno</h5>
                                                ...
                                                <div class="media mt-4">
                                                    <a class="pr-3" href="javascript:void(0)">
                                                        <img src="assets/img/avtar/04.jpg" alt="Generic placeholder image">
                                                    </a>
                                                    <div class="media-body">
                                                        <h5 class="mt-0">Wdcorbitt</h5>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <img class="mr-3 mb-3 mb-xxs-0 img-fluid" src="assets/img/avtar/05.jpg" alt="image">
                                            <div class="media-body">
                                                <h5 class="mt-0">DutcaPatrick</h5>
                                                ...
                                                <p>Try to visualize and then plan for, every possible setback. Commit the plan to paper and then keep it with you at all times. Review it regularly and ensure that every step takes you closer to your Vision and Goals. If the plan doesn’t support the vision then change it!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <img class="align-self-center mr-3 mb-3 mb-xxs-0" src="assets/img/avtar/06.jpg" alt="image">
                                            <div class="media-body">
                                                <h5 class="mt-0">Ansalpa</h5>
                                                ...
                                                <p>You will sail along until you collide with an immovable object, after which you will sink to the bottom</p>
                                                <p>The sad thing is the majority of people have no clue about what they truly want. They have no clarity. When asked the question, responses will be superficial at best, and at worst, will be what someone else wants for them.</p>
                                                <p class="mb-0"> Hey guys! I'd like to share my experience with the developer and they are pretty amazing by answering and fixing the problem in a couple of minutes! defnitely recommend this guys!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <img class="align-self-end mr-3 mb-3 mb-xxs-0" src="assets/img/avtar/07.jpg" alt="image">
                                            <div class="media-body">
                                                <h5 class="mt-0">M_morsch</h5>
                                                ...
                                                <p>We all carry a lot of baggage, thanks to our upbringing. The majority of people carry with them, an entire series of self-limiting beliefs that will absolutely stop, and hold them back from, success. Things like “I’m not good enough”, “I’m not smart enough”, “I’m not lucky enough”, and the worst, “I’m not worthy” are but a few of the self-limiting beliefs I have encountered. </p>
                                                <p class="mb-0">We carry them with us like rocks in a knapsack, and then use them to sabotage our success.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                            <li class="media">
                                                <img class="mr-3 mb-3 mb-xxs-0 img-fluid" src="assets/img/avtar/08.jpg" alt="image">
                                                <div class="media-body">
                                            ...
                                            <li class="media my-4">
                                                <img class="mr-3 mb-3 mb-xxs-0 img-fluid" src="assets/img/avtar/09.jpg" alt="image">
                                                <div class="media-body">
