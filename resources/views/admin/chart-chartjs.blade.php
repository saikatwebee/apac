                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('chart-chartjs') }}">Chartjs Chart</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Chart Js</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartjs-wrapper">
                                            <canvas id="chartjsdemo1" width="800"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Line Styles</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="chartjs-wrapper">
                                            <canvas id="chartjsdemo2" width="800"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Custom Points</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="chartjs-wrapper">
                                            <canvas id="chartjsdemo5" width="800"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Chart Basic</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="chartjs-wrapper">
                                            <canvas id="chartjsdemo6" width="800"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Different Point Sizes</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="chartjs-wrapper">
                                            <canvas id="chartjsdemo7" width="800"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <div class="chartjs-wrapper">
                                            <canvas id="chartjsdemo8" width="800"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
