                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('form-elements') }}">Elements</a> </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Inline Checkboxes and radios</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Read Only Plain Text</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form>
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Read Only Inline Plain Text</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Custom Checkbox and Radios</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Custom Inline Checkbox and Radios</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" class="custom-control-input" id="customCheckInline1">
                                            <label class="custom-control-label" for="customCheckInline1">Check this custom checkbox</label>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Select Menu Sizes</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Select Menu Multi Select</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <select class="custom-select mb-10" multiple>
                                            <option selected>Open this select menu</option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
                                            <option value="3">Three</option>
