                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href='{{ url('index-ecommerce') }}'>Ecommerce</a> </li>
                            ...
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"> <i class="nav-icon ti ti-settings"></i> <span class="nav-title">Widgets</span> <span class="nav-label label label-success">New</span> </a>
                                <ul aria-expanded="false">
                            ...
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-layout-tab-window"></i><span class="nav-title">Tables</span></a>
                                <ul aria-expanded="false">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li> <a href="{{ url('form-file-upload') }}">Drop Zone</a> </li>
