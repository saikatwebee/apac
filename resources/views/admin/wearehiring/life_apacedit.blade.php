                ...
                <div class="breadcrumb-bar align-items-center">
                    <nav>
                        <ol class="breadcrumb p-0 m-b-0">
                            ...
                            <li class="breadcrumb-item active text-primary" aria-current="page">Investor Corner-edit</li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-statistics">
                <div class="card-body">
                  {{-- dir_upload --}}
                  <form action="{{route('life_apac_update',$life_apac->id)}}" method="post" enctype="multipart/form-data" autocomplete="off" id="wearehiring_form" onsubmit="return validateForm();" name="wearehiring_form">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="apac_image">{{__('Life @ APac Image')}}</label><br>
                              ...
                              <input type="file" name="apac_image" id="apac_image" accept="image/png, image/gif, image/jpeg">
                              <div class="pre">
                                <img
                                src="{{ asset('hiring/'.$life_apac->apac_image) }}"  style="margin-left: 2px;
                                margin-top: 3px;"  width="200px" height="120px" id="output"/>
                              </div>
                            <input type="hidden" name="apac_image_img_old" id="apac_image_img_old" value="{{$life_apac->apac_image}}">
