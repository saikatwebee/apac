            ...
            <div class="app-container">
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-dropdowns') }}">Dropdowns</a> </li>
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Dropdowns</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- start Dropdowns contant -->
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card card-statistics widget-blog-contant">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Single Button Dropdown</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="dropdown">
                            ...
                            <div class="col-md-6">
                                <div class="card card-statistics widget-blog-contant">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Link Dropdown</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="dropdown">
                                            <a class="btn btn-primary text-white dropdown-toggle" href="javascript:void(0)" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Dropdown link
                                            </a>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics widget-blog-contant">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Group Button Dropdown</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card card-statistics widget-blog-contant">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Sizing Button Dropdown</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="btn-group mb-2 mr-2 mb-xl-0 mr-xl-0">
                            ...
                            <div class="col-12">
                                <div class="card card-statistics widget-blog-contant">
                                    ...
                                    <div class="card-body">
                                        <div class="btn-group mb-2 mr-2 mb-xl-0 mr-xl-0 dropup">
                                            <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Dropup
                                            </button>
                                            <div class="dropdown-menu">
                            ...
                            <div class="col-12">
                                <div class="card card-statistics widget-blog-contant">
                                    ...
                                    <div class="card-body">
                                        <div class="btn-group mb-2 mr-2 mb-xl-0 mr-xl-0 dropright">
                                            <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Dropright
                                            </button>
                                            <div class="dropdown-menu">
                            ...
                            <div class="col-12">
                                <div class="card card-statistics widget-blog-contant">
                                    ...
                                    <div class="card-body">
                                        <div class="btn-group mb-2 mr-2 mb-xl-0 mr-xl-0 dropleft">
                                            <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Dropleft
                                            </button>
                                            <div class="dropdown-menu">
