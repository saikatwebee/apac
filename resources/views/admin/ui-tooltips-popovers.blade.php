                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-tooltips-popovers') }}">Tooltips & Popovers</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Tooltips & Popovers</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Tootltips</h4>
                                        </div>
                                    </div>


                                    <div class="card-body">
                                        <button type="button" class="tooltip-wrapper btn btn-primary mb-1 mr-1" data-toggle="tooltip" data-placement="right" title="Tooltip on right">
                                            Tooltip on right
                                        </button>
                                        <button type="button" class="tooltip-wrapper btn btn-primary mb-1 mr-1" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
                                            Tooltip on left
                                        </button>
                                        <button type="button" class="tooltip-wrapper btn btn-primary mb-1 mr-1" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                                            Tooltip on top
                                        </button>

                                        <button type="button" class="tooltip-wrapper btn btn-primary mb-1 mr-1" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
                                            Tooltip on bottom
                                        </button>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <button type="button" class="popover-wrapper btn btn-primary mb-1 mr-1" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                            Popover on right
                                        </button>
                                        <button type="button" class="popover-wrapper btn btn-primary mb-1 mr-1" data-container="body" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                            Popover on left
                                        </button>
                                        <button type="button" class="popover-wrapper btn btn-primary mb-1 mr-1" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                            Popover on top
                                        </button>
                                        <button type="button" class="popover-wrapper btn btn-primary mb-1 mr-1" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus
