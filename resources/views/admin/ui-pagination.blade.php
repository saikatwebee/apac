            ...
            <div class="app-container">
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-pagination') }}">Pagination</a> </li>
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Pagination</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row pagination-contant">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Next Prev Icons</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <nav aria-label="Page navigation example">
                            ...
                            <div class="col-md-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Disabled and Active State</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <nav aria-label="...">
                            ...
                            <div class="col-md-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Alignment End</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <nav aria-label="Page navigation example">
