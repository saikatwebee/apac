            ...
            <div class="app-container">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    <li class="active"> <a href="{{ url('widget-chart') }}">Chart Widget</a> </li>
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Chart Widget</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- start chart contant -->
                        <div class="row">
                            <div class="col-12 col-lg-12 col-xxl-7 m-b-30">
                            ...
                            <div class="col-12 col-lg-12 col-xxl-5 m-b-30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-xxl-4 m-b-30">
                                <div class="card card-statistics h-100 mb-0">
                                    <div class="card-header">
                                        <div class="card-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-xxl-5 m-b-30">
                                <div class="card card-statistic car-dealer-contants h-100 mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <h5 class="text-dark">Annual Revenue</h5>
                            ...
                            <div class="col-12 col-xxl-3 m-b-30">
                                <div class="card card-statistics o-hidden h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-heading">
                                            <div class="card-heading">
                        ...
                        <div class="row">
                            <div class="col-12 col-xxl-4 m-b-30">
                                <div class="card card-statistics h-100 mb-0 o-hidden">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Most Viewed Job</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="row crypto-currency">
                            ...
                            <div class="col-xxl-3 m-b-30">
                                <div class="card card-statistics bg-primary o-hidden h-100">
