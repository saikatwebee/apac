            ...
            <div class="app-container">
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-progressbars') }}">Progress Bars</a> </li>
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Progress Bars</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- start Progressbar contant -->
                        <div class="row  progressbar-contant">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Striped Bars</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="progress my-3">
