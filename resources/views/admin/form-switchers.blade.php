                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('form-switchers') }}">Switchers</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Switchers</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2"><b>Checkbox Block (Default Checked)</b></p>
                                        <div class="form-group">
                                        ...
                                        <p class="text-muted mb-2"><b>Checkbox Inline (Default Unchecked)</b></p>
                                        <div class="form-group">
                                        ...
                                        <p class="text-muted mb-2"><b>Checkbox Disabled (Default Checked)</b></p>
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch">
                                                <input type="checkbox" name="switch3" disabled="" checked="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                                        <p class="text-muted mb-2"><b>Checkbox Disabled (Default Unchecked)</b></p>
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch">
                                                <input type="checkbox" name="switch4" disabled="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2"><b>Checkbox Block</b></p>
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-light">
                                                <label>
                                                    <input type="checkbox" name="switch5" checked="" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        </div>
                                        <p class="text-muted mb-2"><b>Checkbox Inline</b></p>
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-light">
                                                <input type="checkbox" name="switch6" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                                        <p class="text-muted mb-2"><b>Checkbox Disabled</b></p>
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-light">
                                                <input type="checkbox" name="switch7" disabled="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted mb-2"><b>Default Checked</b></p>
                                        <div class="form-group">
                                        ...
                                        <p class="text-muted mb-2"><b>Default Unchecked</b></p>
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-success">
                                                <label>
                                        ...
                                        <p class="text-muted mb-2"><b>Default Disabled</b></p>
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-success">
                                                <input type="checkbox" name="switch10" disabled="" checked="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-primary">
                                                <label>
                                                    <input type="checkbox" name="switch11" checked="" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-primary">
                                                <label>
                                                    <input type="checkbox" name="switch12" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-primary">
                                                <input type="checkbox" name="switch13" disabled="" checked="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-info">
                                                <label>
                                                    <input type="checkbox" name="switch14" checked="" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-info">
                                                <label>
                                                    <input type="checkbox" name="switch15" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-info">
                                                <input type="checkbox" name="switch16" disabled="" checked="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-warning">
                                                <label>
                                                    <input type="checkbox" name="switch17" checked="" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-warning">
                                                <label>
                                                    <input type="checkbox" name="switch18" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-warning">
                                                <input type="checkbox" name="switch19" disabled="" checked="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-danger">
                                                <label>
                                                    <input type="checkbox" name="switch20" checked="" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-danger">
                                                <label>
                                                    <input type="checkbox" name="switch21" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-danger">
                                                <input type="checkbox" name="switch22" disabled="" checked="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-dark">
                                                <label>
                                                    <input type="checkbox" name="switch23" checked="" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checbox-switch switch-dark">
                                                <label>
                                                    <input type="checkbox" name="switch24" />
                                                    <span></span>
                                                    Checkbox Label
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="checkbox-inline checbox-switch switch-dark">
                                                <input type="checkbox" name="switch25" disabled="" checked="" />
                                                <span></span>
                                                Checkbox Label
                                            </label>
                                        </div>
