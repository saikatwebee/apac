                ...
                <div class="breadcrumb-bar align-items-center">
                    <nav>
                        <ol class="breadcrumb p-0 m-b-0">
                            ...
                            <li class="breadcrumb-item active text-primary" aria-current="page">Branch - Create</li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-statistics">
                <div class="card-body">
                  <form action="{{route('branch_store')}}" method="post" enctype="multipart/form-data" autocomplete="off" id="about_form" onsubmit="return validateForm();" name="about_form">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">

                        <div class="form-group">
                          <label for="state">{{__('State Name')}} <span class="text-danger">*</span></label>
                          <input type="text" name="state" id="state" class="form-control"  onKeyPress="return ValidateAlpha(event);">
                          <div class="error" id="stateErr"></div>
                        </div>

                        <div class="form-group">
                          <label for="dir_rol">{{__('Pincode')}} <span class="text-danger">*</span></label>
                          <input type="text" name="pincode" id="pincode" class="form-control" onkeypress="return isNumberKey(event)" maxlength="6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="embedded" id="embedded" class="form-control" ></textarea>
                    ...
                    <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="branch" id="branch" class="form-control"  onKeyPress="return ValidateAlpha(event);">
                          <div class="error" id="branchErr"></div>
                          </div>
                          <div class="form-group">
                            <label for="dir_descr">{{__('Address')}} <span class="text-danger">*</span></label>
                            <textarea name="branch_address" id="branch_address" cols="30" rows="10" class="form-control"></textarea>
...
<script>
  ...
  function validateForm() {
    ...
    var stateErr = pincodeErr  = branchErr = branch_addressErr=embeddedErr = true;
