    ...
    <div class="row">
        <div class="col-12">
            <div class="card py-5">
                ...
                <form class="validate-form" method="POST" action="{{ route('contact.update',$contactinfo->id) }}" enctype="multipart/form-data">
                    @csrf
                    {{method_field('PUT')}}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group @error('title') has-error @enderror">
                                    <label for="title" class="control-label">{{ __('Title') }}</label>
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" value="{{$contactinfo->title}}">
                                        @if($errors->has('text'))
                                ...
                                <div class="form-group @error('description') has-error @enderror">
                                    <label for="description" class="control-label">{{ __('Description') }}</label>
                                        ...
                                        <input type="text" class="form-control" name="description" id="description" value="{{$contactinfo->description}}">
                                ...
                                <div class="form-group @error('email') has-error @enderror">
                                    <label for="email" class="control-label">{{ __('Email') }}</label>
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" value="{{$contactinfo->email}}">
                                        @if($errors->has('email'))
                                            <p class="text-danger">{{ $errors->first('email') }}</p>
                                        @endif
                                </div>
                                <div class="form-group @error('phone_number1') has-error @enderror">
                                    <label for="phone_number1" class="control-label">{{ __('Phone number 1 ') }}</label>

                                        <input type="text" class="form-control" name="phone_number1" id="phone_number1" value="{{$contactinfo->phone_number1}}">
                                ...
                                <div class="form-group @error('phone_number2') has-error @enderror">
                                    <label for="phone_number2" class="control-label">{{ __('Phone number 2') }}</label>
                                        ...
                                        <input type="text" class="form-control" name="phone_number2" id="phone_number1" value="{{$contactinfo->phone_number2}}">
