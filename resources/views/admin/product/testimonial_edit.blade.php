                ...
                <div class="breadcrumb-bar align-items-center">
                    <nav>
                        <ol class="breadcrumb p-0 m-b-0">
                            ...
                            <li class="breadcrumb-item active text-primary" aria-current="page">Testimonial - Edit</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="col-12">
            <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <form action="{{route('testimonial_update',$testimonial->id)}}" method="post" enctype="multipart/form-data" autocomplete="off" id="about_form" onsubmit="return validateForm();" name="about_form">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">

                        <div class="form-group">
                          <label for="tes_img">{{__('Testimonial Image')}} <span class="text-danger">*</span></span></label><br>

                              <input type="file" name="tes_img" id="tes_img" accept="image/png, image/gif, image/jpeg">
                              <div class="pre">
                                <img
                                src="{{ asset('product/'.$testimonial->tes_img) }}"  style="margin-left: 2px;
                                margin-top: 3px;"  width="50px" height="50px" id="output"/>
                              </div>
                            <input type="hidden" name="tes_img_old" id="tes_img_old" value="{{$testimonial->tes_img}}">
                          <div class="error" id="tes_imgErr"></div>

                          </div>
                        <div class="form-group">
                          <label for="tes_nme">{{__('Testimonial Name')}} <span class="text-danger">*</span></label>
                          <input type="text" name="tes_nme" id="tes_nme" class="form-control" value="{{$testimonial->tes_nme}}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="tes_rol" id="tes_rol" class="form-control" value="{{$testimonial->tes_rol}}">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea name="tes_descr" id="tes_descr" class="form-control" rows="11" cols="50">{{$testimonial->tes_descr}}</textarea>
...
<script>
  ...
  function validateForm() {
    ...
    var tes_nmeErr = tes_rolErr = tes_descrErr = true;
    ...
    if(tes_descr == "") {
      ...
      if((tes_nmeErr||tes_rolErr||tes_descrErr) == true) {
        return false;
      }
  }
  </script>
