                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-lightbox') }}">Light Box</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Light Box</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row magnific-wrapper">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Single Image Light Box</h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 col-12 col-md-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/01.jpg" class="view"><img src="assets/img/widget/01.jpg" class="img-fluid" alt="small-img-1"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/02.jpg" class="view"><img src="assets/img/widget/02.jpg" class="img-fluid" alt="small-img-2"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/03.jpg" class="view"><img src="assets/img/widget/03.jpg" class="img-fluid" alt="small-img-3"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/04.jpg" class="view"><img src="assets/img/widget/04.jpg" class="img-fluid" alt="small-img-4"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/05.jpg" class="view"><img src="assets/img/widget/05.jpg" class="img-fluid" alt="small-img-5"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/06.jpg" class="view" title="The Cleaner"><img src="assets/img/widget/06.jpg" class="img-fluid" alt="small-img-6"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Light Box Gallery</h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 col-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/07.jpg" class="view1"><img src="assets/img/widget/07.jpg" class="img-fluid" alt="small-img-7"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/08.jpg" class="view1"><img src="assets/img/widget/08.jpg" class="img-fluid" alt="small-img-8"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/09.jpg" class="view1"><img src="assets/img/widget/09.jpg" class="img-fluid" alt="small-img-9"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="{{ url('assets/img/widget/010') }}" class="view1"><img src="assets/img/widget/10.jpg" class="img-fluid" alt="small-img-10"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/01.jpg" class="view1"><img src="assets/img/widget/01.jpg" class="img-fluid" alt="small-img-11"></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="card-body">
                                                <div class="gallery">
                                                    <a href="assets/img/widget/02.jpg" class="view1"><img src="assets/img/widget/02.jpg" class="img-fluid" alt="small-img-12"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
