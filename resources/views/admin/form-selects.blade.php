                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('form-selects') }}">Selects</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Selects</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12 selects-contant-boots">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Markup boxes</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="form-group mb-0 bs-select-1">
                                                    <input type="text" class="bs-input" value="Amsterdam,Washington,Sydney,Beijing,Cairo" data-role="tagsinput" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12 selects-contant-boots">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">True multi value</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="form-group mb-0 bs-select-1">
                                                    <select class="bs-input" multiple data-role="tagsinput">
