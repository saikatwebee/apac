            ...
            <div class="app-container">
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('form-range-slider') }}">Range Slider</a> </li>
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Range Sliders</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <!-- end row -->
                        <!-- begin row -->
                        <div class="row rangeslider-wrapper">
                            <div class="col-12">
                                <h4>Basic Slider</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <div class="slider-2">
                                                    <input type="text" id="slider-2" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Set type to double and specify range, also showing grid and adding </h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-3">
                                                    <input type="text" id="slider-3" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <div class="slider-2">
                                                    <input type="text" id="slider-4" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Using step 250</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-5">
                                                    <input type="text" id="slider-5" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Set up range with fractional values, using fractional step</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-6">
                                                    <input type="text" id="slider-6" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Set up you own numbers</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-7">
                                                    <input type="text" id="slider-7" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Using any strings as your values</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-8">
                                                    <input type="text" id="slider-8" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">One more example with strings</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-9">
                                                    <input type="text" id="slider-9" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">No prettify. Big numbers are ugly and unreadable</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-10">
                                                    <input type="text" id="slider-10" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Prettify enabled. Much better!</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-11">
                                                    <input type="text" id="slider-11" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Don't like space as separator? Use anything you like!</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-12">
                                                    <input type="text" id="slider-12" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">You don't like default prettify function? Use your own!</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-13">
                                                    <input type="text" id="slider-13" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Using prefixes</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-14">
                                                    <input type="text" id="slider-14" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Using postfixes</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-15">
                                                    <input type="text" id="slider-15" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Want to show that max number is not the biggest one?</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-16">
                                                    <input type="text" id="slider-16" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Taking care about how from and to values connect? Use decorate_both</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="slider-17">
                                                    <input type="text" id="slider-17" name="example_name" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <h4>Interactions Slider</h4>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card card-statistics">
                                                <div class="card-header">
                                                    <div class="card-heading">
                                                        <h4 class="card-title">There are four different callbacks:</h4>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <div class="slider-inter_1">
                                                        <input type="text" id="slider-inter_1" name="example_name" value="" />
                                                        <button class="btn btn-primary mt-2 js-update-43">Set slider value to 10</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
