                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="{{ url('ui-typography') }}">Typography</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Typography</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-30">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <h1>h1. heading</h1>
                                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque dolores quidem
                                            qui aspernatur ipsum accusantium fugiat soluta commodi esse.</p>
                                        <h2 class="mt-30">h2. heading</h2>
                                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque dolores quidem
                                            qui aspernatur ipsum accusantium fugiat soluta commodi esse.</p>
                                        <h3 class="mt-30">h3. heading</h3>
                                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque dolores quidem
                                            qui aspernatur ipsum accusantium fugiat soluta commodi esse.</p>
                                        <h4 class="mt-30">h4. heading</h4>
                                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque dolores quidem
                                            qui aspernatur ipsum accusantium fugiat soluta commodi esse.</p>
                                        <h5 class="mt-30">h5. heading</h5>
                                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque dolores quidem
                                            qui aspernatur ipsum accusantium fugiat soluta commodi esse.</p>
                                        <h6 class="mt-30">h6. heading</h6>
                                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque dolores quidem
                                            qui aspernatur ipsum accusantium fugiat soluta commodi esse.</p>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Marked text</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Deleted text</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Strikethrough text</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card card-statistics mb-30">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Underlined text</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
