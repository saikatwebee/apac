...
<header class="app-header top-bar">
    <nav class="navbar navbar-expand-md">
        ...
        <div class="navbar-header d-flex align-items-center">
            ...
            <!--</a>-->
            <a class="navbar-brand" href="{{ url('/admin/dashboard_page/application_form_list') }}" style="
            font-size: 30px;
            ">
                <img src="{{ asset('media/logos/logo-1.jpg') }}" class="img-fluid logo-desktop" alt="logo" style=" width: 50px !important;"/>
                <img src="{{ asset('media/logos/logo-1.jpg') }}" class="img-fluid logo-mobile" alt="logo" />APACFIN
                <!--<img src="{{ asset('media/logos/d2.png') }}" class="img-fluid logo-desktop" alt="logo" style=" width: 50px !important;"/>-->
                <!--<img src="{{ asset('media/logos/d2.png') }}" class="img-fluid logo-mobile" alt="logo" />APACFIN-->
            </a>
        </div>
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid"
                                                            src="{{ asset('admin/assets/img/avtar/03.jpg') }}"
                                                            alt="user3">
                                                    </div>
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid"
                                                            src="{{ asset('admin/assets/img/avtar/01.jpg') }}"
                                                            alt="user">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid"
                                                            src="{{ asset('admin/assets/img/avtar/02.jpg') }}"
                                                            alt="user2">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid"
                                                            src="{{ asset('admin/assets/img/avtar/04.jpg') }}"
                                                            alt="user4">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid"
                                                            src="{{ asset('admin/assets/img/avtar/05.jpg') }}"
                                                            alt="user5">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid"
                                                            src="{{ asset('admin/assets/img/avtar/06.jpg') }}"
                                                            alt="user6">
                                                    </div>
                                                    <div class="notify-message">
                    ...
                    <li class="nav-item dropdown user-profile">
                        ...
                        <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="text-white font-20 tooltip-wrapper"
                            ...
                            <div class="p-4" style="display:none;">
                                <a class="dropdown-item d-flex nav-link" href="{{ url('profile') }}">
                                ...
                                {{-- <a class="dropdown-item d-flex nav-link" href="javascript:void(0)">
                                    <i class="zmdi zmdi-sign-out pr-2 text-danger"></i> Logout
                                </a> --}}
                                {{-- <div class="row mt-2">
                                    <div class="col">
