...
(function(window, document, $, undefined){
  ...
  $(function(){
        var summernote = jQuery(".summernote,.terms_condition,.limited_license,.contents,.use_service,.intellectual_property,.confi_information,.disclaimer_warranty,.indemnification,.limit_liablity,.software_license,.disclaimer_rbi,.introduction,.apps_of_policy,.process_of_handle,.branch_require,.registration_of_complaint,.interaction_with_customers,.operating_staff,.esclation_of_complaint,.summernote1,.summernote2,.summernote3,.summernote4,.summernote5,.summernote6,.summernote7,.summernote8,.summernote9,.summernote10,.summernote11,.summernote12");
        if (summernote.length > 0) {
                $('#summernote,#terms_condition,#limited_license,#contents,#use_service,#intellectual_property,#confi_information,#disclaimer_warranty,#indemnification,#limit_liablity,#software_license,#disclaimer_rbi,#introduction,#apps_of_policy,#process_of_handle,#branch_require,#registration_of_complaint,#interaction_with_customers,#operating_staff,#esclation_of_complaint,#summernote1,#summernote2,#summernote3,#summernote4,#summernote5,#summernote6,#summernote7,#summernote8,#summernote9,#summernote10,#summernote11,#summernote12').summernote({
                    tabsize: 1,
                    height: 250,
                    fontNames: [
                        'Montserrat','Serif', 'Sans'
                    ],
                    toolbar: [
                        ['style', ['style']],
                        ['fontsize', ['fontsize']],
                      ...
                      fontSizes: [ '14', '15', '16', '18', '20', '22' , '24'],
                      colors: [['#000', '#fff','#CCCCCC','#F49C41','red','green','yellow','#f517f5']],
                });
        }
    });
